...
def get_face_detector(modelFile=None,
    ...
    if quantized:
        if modelFile == None:
            modelFile = "F:/2024/MITS BTEC/studentAttendance/spApp/models/opencv_face_detector_uint8.pb"
        if configFile == None:
            configFile = "F:/2024/MITS BTEC/studentAttendance/spApp/models/opencv_face_detector.pbtxt"
        model = cv2.dnn.readNetFromTensorflow(modelFile, configFile)

    else:
        if modelFile == None:
            modelFile = "F:/2024/MITS BTEC/studentAttendance/spApp/models/res10_300x300_ssd_iter_140000.caffemodel"
        if configFile == None:
            configFile = "F:/2024/MITS BTEC/studentAttendance/spApp/models/deploy.prototxt"
