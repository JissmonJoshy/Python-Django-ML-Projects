...
def weights_download(out='F:/2024/MITS BTEC/studentAttendance/spApp/models/yolov3.weights'):
    _ = wget.download(
        'https://pjreddie.com/media/files/yolov3.weights', out='F:/2024/MITS BTEC/studentAttendance/spApp/models/yolov3.weights')
...
def main(vid):
    ...
    load_darknet_weights(
        yolo, 'F:/2024/MITS BTEC/studentAttendance/spApp/models/yolov3.weights')
    ...
    while (True):
        ...
        img = img / 255
        class_names = [c.strip()
                       for c in open("F:/2024/MITS BTEC/studentAttendance/spApp/models/classes.TXT").readlines()]
